...
function countNissanFromCK() {
  const nissanCKCars = cars.filter(car => car.make === "Nissan" && car.reg_number.startsWith("CK"));
  return nissanCKCars.length;
}

export { cars, countNissanFromCK };